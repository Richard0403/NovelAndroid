...
//        //如果文件不存在，则打开失败
//        File file = new File(AppConfig.BOOK_CACHE_PATH + bookId
//                + File.separator + chapterName + FileUtil.SUFFIX_NB);
//        if (!file.exists()){
//            return false;
//        }
//        this.bookId = bookId;
...
//            char[] array = FileUtil.getFileContent(file).toCharArray();
...
//        if (block == null) {
//            File file = getBookFile(bookId, chapterName);
//            block = FileUtil.getFileContent(file).toCharArray();
...
//        return FileUtil.getFile(AppConfig.BOOK_CACHE_PATH + folderName
//                + File.separator + fileName + FileUtil.SUFFIX_NB);
//    }
//
//    public static long getBookSize(String folderName){
//        return FileUtil.getDirSize(FileUtil
//                .getFolder(AppConfig.BOOK_CACHE_PATH + folderName));
//    }
...
//        File file = new File(AppConfig.BOOK_CACHE_PATH + folderName
//                + File.separator + fileName + FileUtil.SUFFIX_NB);
//        return file.exists();
//    }
